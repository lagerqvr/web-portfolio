        ...
        <div className="min-h-screen flex items-start justify-center px-16 bg-black pt-10">
          ...
          <div className="relative w-full max-w-2xl">
            ...
            <div className="absolute top-0 left-0 right-0 bottom-0 z-0">
              ...
              <div className="absolute top-0 -right-4 w-72 h-72 bg-red-500 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
