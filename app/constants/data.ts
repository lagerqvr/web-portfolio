const userData = {
    about: {
        ...
        contact: [
            "Want to collaborate on something or just have a question? Down below you can find my social links if you want to reach out. I'll get back to you as soon as possible."
        ],
    ...
    projects: {
        introduction: "Every developer inevitably creates some personal projects to expand their skillset or to solve a problem. Here you can find some of my featured projects and also my most recent creations.",
        featured: [
            {
                title: "Sitzy.app",
